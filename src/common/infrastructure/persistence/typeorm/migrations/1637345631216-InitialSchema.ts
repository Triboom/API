...
export class InitialSchema1637345631216 implements MigrationInterface {
    name = 'InitialSchema1637345631216'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`sales\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`orderQuantity\` int NOT NULL, \`dateTime\` date NOT NULL, \`orderStatus\` tinyint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    }
